        ...
        for event in events:
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_PAGEDOWN:
                    phi=phi-2.5
        light = np.array([-240,-175,0])
        s1.Throws_fill(-240,-175,0,60,zvp,zprp,phi,theta,gama,my_screen,z_buffer)
        c1.definecuboidfill(100,100,100,150,150,150,zvp,zprp,phi,theta,gama,my_screen,z_buffer,light)
        pygame.display.flip()
